module SUB_3 #(parameter Addr = 9,parameter DATA = 15) (clk,rst,HSELx,ADDR,HWRITE1,HBURST,HTRANS,HDATA,HSIZE,HREADYOUT_2,HRESP_2,HRDATA_2);
...
input [2:0]HSIZE;
input [2:0]HBURST;
output reg HREADYOUT_2 = 1'b1;
output reg HRESP_2 = 1'b0;
output reg [DATA:0] HRDATA_2;
localparam IDLE = 2'b00;
localparam WRITE = 2'b01;
localparam READ = 2'b10;
localparam SUB_3 = 2'b10;
