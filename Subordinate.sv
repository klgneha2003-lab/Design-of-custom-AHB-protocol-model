module subordinate #(parameter Addr = 9,parameter DATA = 15)(clk,rst,HSELx,ADDR,HTRANS,HBURST,HWRITE1,HDATA,HSIZE,HREADYOUT_0,HRESP_0,HRDATA_0);
...
input [2:0]HSIZE;
input [1:0]HTRANS;
output reg HREADYOUT_0 = 1'b1;
output reg HRESP_0 = 1'b0;
output reg [DATA:0] HRDATA_0;
reg error = 0;
